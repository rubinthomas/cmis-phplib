...
class CMISRepositoryWrapper
{
    ...
    static $namespaces = array (
      ...
      #"cmisms" => "http://docs.oasis-open.org/ns/cmis/messaging/200908/",
      #"cmisws" => "http://docs.oasis-open.org/ns/cmis/ws/200908/",
      #"cmislink" => "http://docs.oasis-open.org/ns/cmis/link/200908/",
    ...
    static function processTemplate($template, $values = array ())
    {
        ...
        // Fill in any unpopulated variables with ""
            ...
            if ($pn->attributes) {
                if( $pn->getElementsByTagName("value")->length <= 1)
                    ...
                    for($i=0; $i < $pn->getElementsByTagName("value")->length; $i++)
                        $value[$i] = $pn->getElementsByTagName("value")->item($i)->nodeValue;
                    //supressing errors since PHP sometimes sees DOM elements as "non-objects"
                    @$retval->properties[$pn->attributes->getNamedItem("propertyDefinitionId")->nodeValue] = $value;
                    $value=NULL;
                }
            }
        }
